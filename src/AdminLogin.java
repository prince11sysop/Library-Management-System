...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("This project has been developed under the guidence of Dr. K K Sir");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String s="admin2157";
        if(id==2157 && pwd.equals(s)) {
            
            setVisible(false);
            Home ob=new Home();
            ob.setVisible(true);
            
        }else JOptionPane.showMessageDialog(null, "Incorrect Registration Id or password");
